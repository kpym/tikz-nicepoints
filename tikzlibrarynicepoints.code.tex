...
% To show or not the point label
\newif\ifshowlabel
...
\tikzset{
  ...
  point coordinate/.style={label={[coordinate,name=#1]center:}},
  /nice point/show label/.is if=showlabel,
  quotes mean point/.style={
    node quotes mean/.try={point coordinate=##1,
      label={[direction shorthands, every label quotes/.try, /nice point/show label, ##2]{\ifshowlabel\ensuremath{##1}\fi}}
    },
    '/.style={/nice point/show label=false},
    */.style='
  },
  point/.style={quotes mean point,/nice point/show label,
    insert path={
